...
namespace AskFm.DAL.Migrations
{
    ...
    [Migration("20260711185910_FixNotificationMessageLength")]
    partial class FixNotificationMessageLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AskFm.DAL.Models.UserBlock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AskFm.DAL.Models.UserMute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AskFm.DAL.Models.UserBlock", b =>
                {
                    b.HasOne("AskFm.DAL.Models.ApplicationUser", "Blocked")
                        .WithMany("BlockedByUsers")
                        .HasForeignKey("BlockedId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("AskFm.DAL.Models.ApplicationUser", "Blocker")
            ...
            modelBuilder.Entity("AskFm.DAL.Models.UserMute", b =>
                {
                    b.HasOne("AskFm.DAL.Models.ApplicationUser", "Muted")
                        .WithMany("MutedByUsers")
                        .HasForeignKey("MutedId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("AskFm.DAL.Models.ApplicationUser", "Muter")
                        .WithMany("MutedUsers")
